    ...
    OneNetApi.prototype = {
        ...
        getDeviceInfo: function(deviceId) {
            ...
            return new Promise((resolve, reject) => {
                jsonp(API_HOST + '/api/jsonpresend?key='+ _this._apiKey+'&method=GET&uri=devices/'+deviceId, (error, res) => {
        ...
        getDataStreams: function(deviceId){
            ...
            return new Promise((resolve, reject) => {
                jsonp(API_HOST + '/api/jsonpresend?key='+ apiKey +'&method=GET&uri=devices/'+deviceId+'/datastreams', function(error, res){
                    if(error || !res.hasOwnProperty('data')){
                        reject({
                            errno: 100,
                            error: 'timeout'
        ...
        getDataPoints: function(deviceId, parameter){
            ...
            return new Promise((resolve, reject) => {
                jsonp(API_HOST + '/api/jsonpresend?key=' + _this._apiKey + '&method=GET&uri=' + uri, function(error, res){
                    if(error || !res.hasOwnProperty('data')){
                        reject({
                            errno: 100,
                            error: 'timeout'
