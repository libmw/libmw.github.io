 ...
 * 提交裁切好的图片到服务器
 * */
ImageCliper.prototype.submit = function(){
    this._flash.submit();
};
 ...
 * */
ImageCliper.prototype.setImageSrc = function(url){
 ...
 * 绑定事件
 * */
ImageCliper.prototype.bind = function(evt, func){
    if(!this._events[evt]){
        this._events[evt] = [];
    }
 ...
 * 取消绑定事件
 * */
ImageCliper.prototype.unbind = function(evt, func){
    if(this._events[evt]){
 ...
 * 触发事件
 * */
ImageCliper.prototype.trigger = function(evt, data){
    if(this._events[evt]){
        var events = this._events[evt];
        for(var i = 0; i < events.length; i ++){
...
ImageCliper.prototype._init = function(){
    this._initFlashvars();
    this._generateCallBack();
    this._initUI();
};

ImageCliper.prototype._initFlashvars = function(){
    var varArr = [
...
ImageCliper.prototype._initUI = function(){
...
ImageCliper.prototype._generateCallBack = function(){
...
ImageCliper.prototype._decodeCamel = function(camel){
